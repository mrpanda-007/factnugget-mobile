...
Repositories are the single data-access API that hooks and TanStack Query call into. They exist to keep UI and business logic ignorant of _which_ backend (Firebase, Sanity, StoreKit) or _which_ cache (SQLite) is actually serving a piece of data.
