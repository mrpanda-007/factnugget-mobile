...
| `database/`                | Expo SQLite schema, migrations, and queries. SQLite V4 includes the local cloud account binding and family-scoped durable sync outbox; no Firestore code lives here.                                                          |
